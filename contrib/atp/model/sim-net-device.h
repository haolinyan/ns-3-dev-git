#ifndef SIM_NET_DEVICE_H
#define SIM_NET_DEVICE_H
...
class SimNetDevice : public NetDevice
{
  public:
    /**
    ...
    /**
     * Construct a SimNetDevice
     *
     * This is the constructor for the SimNetDevice.  It takes as a
    ...
    /**
     * Destroy a SimNetDevice
     *
     * This is the destructor for the SimNetDevice.
     */
    ~SimNetDevice() override;

    // Delete copy constructor and assignment operator to avoid misuse
    SimNetDevice& operator=(const SimNetDevice&) = delete;
    SimNetDevice(const SimNetDevice&) = delete;
     ...
     */
    bool Attach(Ptr<SimChannel> ch);

    /**
     * Attach a queue to the SimNetDevice.
     *
     * The SimNetDevice "owns" a queue that implements a queueing
    ...
    void SetPriorityQueue(Ptr<Queue<Packet>> queue);
    ...
    /**
     * Attach a receive ErrorModel to the SimNetDevice.
     *
     * The SimNetDevice may optionally include an ErrorModel in
    ...
    /**
     * Receive a packet from a connected SimChannel.
     *
     * The SimNetDevice receives packets from its connected channel
    ...
    bool SendWithPriority(Ptr<Packet> packet, const Address& dest, uint16_t protocolNumber, uint32_t priority);
  ...
  protected:
    ...
    /**
     * The SimChannel to which this SimNetDevice has been
     * attached.
     */
    Ptr<SimChannel> m_channel;

    /**
     * The Queue which this SimNetDevice uses as a packet source.
     * Management of this Queue has been delegated to the SimNetDevice
     * and it has the responsibility for deletion.
     * \see class DropTailQueue
     */
    Ptr<Queue<Packet>> m_queue;
    Ptr<Queue<Packet>> m_priorityQueue;
