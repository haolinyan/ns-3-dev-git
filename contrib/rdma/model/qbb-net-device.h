...
public:
  ...
  typedef void (*RdmaPktSent)(Ptr<RdmaQueuePair>, Ptr<Packet>, Time);
...
public:
  ...
  typedef void (*QbbNDQueueTrace)(Ptr<const Packet>, uint32_t);
...
public:
  ...
  typedef void (*QbbNDQueueCallback)(Ptr<const Packet>, Ptr<RdmaQueuePair>);
